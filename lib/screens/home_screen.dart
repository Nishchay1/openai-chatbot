      ...
      barrierDismissible: false,
        ...
        builder: (context) => AlertDialog(
          title: Text("Disclaimer"),
              ...
              actions: [TextButton(onPressed: ()=>Navigator.of(context).pop(), child: Text(style: TextStyle(fontSize: 18), "I Understand")),TextButton(onPressed: ()=>SystemChannels.platform.invokeMethod('SystemNavigator.pop'), child: Text(style: TextStyle(fontSize: 18), "Quit"))],
            ));
  }
}
