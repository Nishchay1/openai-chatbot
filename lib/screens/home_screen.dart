    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
          title: Text("Disclaimer"),
              ...
              actions: [TextButton(onPressed: ()=>Navigator.of(context).pop(), child: Text("I Understand")),TextButton(onPressed: ()=>SystemChannels.platform.invokeMethod('SystemNavigator.pop'), child: Text("Quit"))],
            ));
  }
}
